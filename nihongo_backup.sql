...
CREATE TABLE public.kanji (
    ...
    kunyomi character varying(100) NOT NULL,
...
163	右	u	migi	right
117	電	den		electricity
150	駅	eki		station
151	町	machi		town
153	学校	gakkou		school
154	会社	kaisha		company
\.
...
COPY public.task_imagen (id, image_path, category, japanese_word, pronunciation, user_id) FROM stdin;
\.
...
COPY public.word (id, japanese, english, pronunciation, user_id) FROM stdin;
10	ねこ	cat	ne-ko	\N
11	いぬ	dog	i-nu	\N
12	さくら	cherry blossom	sa-ku-ra	\N
13	ほん	book	hon	\N
14	やま	mountain	yama	\N
15	うみ	sea	umi	\N
16	さけ	salmon	sa-ke	\N
17	さとう	sugar	sa-to-u	\N
18	きょう	today	kyo-u	\N
19	あさ	morning	a-sa	\N
20	よる	night	yo-ru	\N
21	たべる	to eat	ta-be-ru	\N
22	のむ	to drink	no-mu	\N
23	ねる	to sleep	ne-ru	\N
24	はな	flower	ha-na	\N
25	おおきい	big	oo-ki-i	\N
26	ちいさい	small	chi-i-sa-i	\N
27	あたらしい	new	a-ta-ra-shi-i	\N
28	ふるい	old	fu-ru-i	\N
29	かわいい	cute	ka-wa-i-i	\N
30	たかい	high	ta-ka-i	\N
31	ひくい	low	hi-ku-i	\N
32	あつい	hot	a-tsu-i	\N
33	さむい	cold	sa-mu-i	\N
34	あめ	rain	a-me	\N
35	ゆき	snow	yu-ki	\N
36	からだ	body	ka-ra-da	\N
37	あたま	head	a-ta-ma	\N
38	みみ	ear	mi-mi	\N
39	め	eye	me	\N
40	はし	chopsticks	ha-shi	\N
41	くるま	car	ku-ru-ma	\N
42	でんしゃ	train	den-sha	\N
43	じてんしゃ	bicycle	ji-ten-sha	\N
44	ひこうき	airplane	hi-kou-ki	\N
45	バス	bus	ba-su	\N
46	みせ	store	mi-se	\N
47	レストラン	restaurant	res-to-ran	\N
48	とけい	watch	to-ke-i	\N
49	かばん	bag	ka-ban	\N
50	ぺん	pen	pen	\N
51	えんぴつ	pencil	en-pi-tsu	\N
52	ノート	notebook	no-to	\N
53	けいたい	cell phone	kei-ta-i	\N
54	コンピュータ	computer	kon-pyu-ta	\N
55	テレビ	television	te-re-bi	\N
56	ラジオ	radio	ra-ji-o	\N
57	うた	song	u-ta	\N
58	おんがく	music	on-ga-ku	\N
59	しごと	work	shi-go-to	\N
60	べんきょう	study	ben-kyou	\N
61	だいがく	university	dai-ga-ku	\N
62	しゅくだい	homework	shu-ku-dai	\N
63	おおさか	Osaka	o-o-sa-ka	\N
64	とうきょう	Tokyo	to-u-kyo-u	\N
1	こんにちは	Hello	Konnichiwa	\N
2	ありがとう	Thank you	Arigatou	\N
3	さようなら	Goodbye	Sayounara	\N
\.
...
--
-- Name: task_imagen task_imagen_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.task_imagen
    ADD CONSTRAINT task_imagen_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);


--
-- Name: word word_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.word
    ADD CONSTRAINT word_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);
